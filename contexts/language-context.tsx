...
const translations = {
  ...
  he: {
    ...
    "evaluate.fields.yad2Url": "כתובת יד2",
    "evaluate.fields.yad2UrlPlaceholder": "הדבק כתובת מודעת רכב מיד2",
    ...
    "evaluate.errors.urlRequired": "כתובת יד2 נדרשת",
    "evaluate.errors.invalidUrl": "כתובת לא תקינה",
    "evaluate.errors.yad2Only": "רק כתובות יד2 נתמכות",
    "evaluate.errors.evaluationError": "שגיאת הערכה",
    "evaluate.errors.unknownError": "אירעה שגיאה לא ידועה",
    ...
    "results.backToEvaluate": "חזור להערכה",
    "results.share.title": "תוצאות הערכת רכב",
    "results.share.text": "בדוק את תוצאות הערכת הרכב שלי!",
